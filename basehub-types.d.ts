...
export type AuthorsItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'avatar__ASC' | 'avatar__DESC' | 'name__ASC' | 'name__DESC' | 'role__ASC' | 'role__DESC' | 'untitled__ASC' | 'untitled__DESC'
...
export type BlockDocument = (Authors | AuthorsItem | BlogIndex | BlogPosts | BlogPostsItem | Categories | CategoriesItem | Collections | _AgentStart | authorsItem_AsList | blogPostsItem_AsList | categoriesItem_AsList) & { __isUnion?: true }
...
export type BlockList = (Authors | BlogPosts | Categories | authorsItem_AsList | blogPostsItem_AsList | categoriesItem_AsList) & { __isUnion?: true }
...
export type BlogPostsItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'author__ASC' | 'author__DESC' | 'body__ASC' | 'body__DESC' | 'category__ASC' | 'category__DESC' | 'coverImage__ASC' | 'coverImage__DESC' | 'date__ASC' | 'date__DESC' | 'isPublished__ASC' | 'isPublished__DESC' | 'subtitle__ASC' | 'subtitle__DESC'
...
export interface BlockDocumentGenqlSelection{
    ...
    on_BlogIndex?: BlogIndexGenqlSelection
...
export interface BlogIndexGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface QueryGenqlSelection{
    ...
    blogIndex?: BlogIndexGenqlSelection
...
export interface FragmentsMap {
  ...
  BlogIndex: {
    root: BlogIndex,
    selection: BlogIndexGenqlSelection,
}
  BlogPosts: {
    root: BlogPosts,
